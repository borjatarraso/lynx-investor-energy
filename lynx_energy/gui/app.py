...
class LynxEnergyGUI:
    ...
    def _after_splash(self) -> None:
        ...
        from lynx_energy.tui.themes import HOUSE_THEMES as _HOUSE_THEMES
        ...
        try:
            ...
            pass
        self._theme_cycler = ThemeCycler(self.root, start="energy-dark")
    ...
    def _show_themes_menu(self) -> None:
        ...
        sector_family = ["energy-dark", "energy-light"]
