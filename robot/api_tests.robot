...
New Energy Metrics FCF Yield And CROCI Exist
    ...
    When I Run Python Code "from lynx_energy.models import ValuationMetrics, ProfitabilityMetrics; assert hasattr(ValuationMetrics(), 'fcf_yield'); assert hasattr(ProfitabilityMetrics(), 'croci'); print('OK')"
    Then The Exit Code Should Be 0
    Then The Output Should Contain "OK"
...
New Energy Metrics Capex To Revenue Exists
    ...
    When I Run Python Code "from lynx_energy.models import GrowthMetrics, EfficiencyMetrics; assert hasattr(GrowthMetrics(), 'capex_to_revenue'); assert hasattr(GrowthMetrics(), 'capex_to_ocf'); assert hasattr(EfficiencyMetrics(), 'capex_intensity'); print('OK')"
    Then The Exit Code Should Be 0
    Then The Output Should Contain "OK"
...
New Energy Metrics Profitability Fields Exist
    ...
    When I Run Python Code "from lynx_energy.models import ProfitabilityMetrics, GrowthMetrics; assert hasattr(ProfitabilityMetrics(), 'ocf_to_net_income'); assert hasattr(GrowthMetrics(), 'fcf_per_share'); assert hasattr(GrowthMetrics(), 'ocf_per_share'); print('OK')"
    Then The Exit Code Should Be 0
    Then The Output Should Contain "OK"
