...
Severity Markers Use New Format
    ...
    When I Run Python Code "from lynx_energy import display; import inspect; src = inspect.getsource(display); assert '***CRITICAL***' in src; assert '*WARNING*' in src; assert '[WATCH]' in src; print('OK')"
    Then The Exit Code Should Be 0
